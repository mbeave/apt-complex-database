/*
    of the apartments with no tenants currently, list the apt number, the direction it's facing, the building
    nickname, floor number, rental price, and its color scheme
*/
